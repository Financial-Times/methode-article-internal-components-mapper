...
public class BodyProcessingStepDefs {
	...
	private static final String CONTENT_STORE_AUDIO_UUID = "bf96e6f7-27fa-43f8-8a58-3348cfa4b70e";
    ...
    public void setup() throws Exception {
       ...
       // List<String> contentuuid = Collections.singletonList(CONTENT_STORE_UUID);
     ...
     //  List<String> audiouuid = Collections.singletonList(CONTENT_STORE_AUDIO_UUID);
       //when(documentStoreApiClient.getContentForUuids(audiouuid, anyString())).thenReturn(audio);
